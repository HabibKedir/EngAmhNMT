...
get_ipython().system('pip install tensorflow keras')
...
eng_path = os.path.join(data_dir, "Amh.txt")
amh_path = os.path.join(data_dir, "Eng.txt")
...
# Import Tokenizer from tf.keras
from tensorflow.keras.preprocessing.text import Tokenizer
from tensorflow.keras.preprocessing.sequence import pad_sequences
